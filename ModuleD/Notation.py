...
class Ui_TreeNotaion(object):
    def setupUi(self, TreeNotaion):
        ...
        self.gridLayout_3.addWidget(self.ThetaDispalyer, 4, 1, 1, 1)
        self.OmegaUp = QtWidgets.QLineEdit(self.widget_3)
        self.OmegaUp.setObjectName("OmegaUp")
        self.gridLayout_3.addWidget(self.OmegaUp, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.OmigaDispalyer, 2, 1, 1, 1)
        ...
        self.OmegaDown = QtWidgets.QLineEdit(self.widget_3)
        self.OmegaDown.setObjectName("OmegaDown")
        self.gridLayout_3.addWidget(self.OmegaDown, 3, 1, 1, 1)
    ...
    def retranslateUi(self, TreeNotaion):
        ...
        self.label_2.setText(_translate("TreeNotaion", "Function:"))
        self.label_11.setText(_translate("TreeNotaion", "Omega(上界):"))
        self.label.setText(_translate("TreeNotaion", "BigO:"))
        self.label_12.setText(_translate("TreeNotaion", "Omega(下界):"))
